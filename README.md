...
一个面向创业项目判断的顾问型技能，适用于 Codex 风格的工作流，也可以直接让 Claude Code 基于本仓库内容创建适用于 Claude 的同类 skill。

这个 skill 既适用于 AI 原生项目，也适用于传统服务、工具、渠道、内容和线下生意。它强调证据、阶段纪律和可执行动作，而不是泛泛而谈的灵感讨论。

这个 skill 基于 Anthropic 公司提出的《AI 原生创业者手册》相关方法论进行整理与扩展，主要用于学习交流与创业项目分析方法的实践参考。
